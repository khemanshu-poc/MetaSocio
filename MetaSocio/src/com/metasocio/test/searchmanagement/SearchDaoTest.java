...
public class SearchDaoTest {
	...
	public void test1() throws MetaSocioException {
		...
		assertNotNull(searchDao.retrieveUsersByKey(session,"ch", "chetna.sharma@metacube.com"));
	}
	...
	public void test2() throws MetaSocioException {
		...
		List<User> listOfUser = searchDao.retrieveUsersByKey(session,"ch", "chetna.sharma@metacube.com");
		String listString = "[";
