            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                   ...
                   <%HttpSession session=request.getSession(false);
            		...
            		%>
                    <li>
                        <a class="page-scroll" href="https://accounts.google.com/o/oauth2/auth?scope=email&amp;redirect_uri=http://localhost:8080/MetaSocio/OAuth&amp;response_type=code&amp;client_id=
    ...
    <section id="about">
        <div class="container wow fadeIn">
            <div class="row" style="margin-top: 20px;">
                ...
                <div class="col-md-6 text-center" style="background-color: #ffb3b3">
                    <h1>META-SOCIO</h1>
                    <hr class="colored">
